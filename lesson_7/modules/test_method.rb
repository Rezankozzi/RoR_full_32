#   в test_metod  создаются поезда двух типов, к ним прицепляются по пять вагонов соответствующего типа.
...
module TestMethod
  ...
  train2 = Train.new( "TRa-#{rand(20..30)}", :passenger)
  ...
  wagon_pass = PassengerWagon.new( "WG-#{rand(100..150)}", [40, 60, 120].sample)
